  ...
  return (
    <section id="home" className="h-screen  flex items-center justify-center bg-gradient-to-t from-[#0C0C0C] to-[#6e6666] relative overflow-hidden">
      <div className="absolute right-0 top-0 w-full ">
        ...
        <div className="rgbColor flex items-center justify-between py-4 px-6 w-full rounded-3xl border border-white border-opacity-40 md:text-2xl font-bold text-white opacity-90 shadow-2xl backdrop-blur-xl"> 
      ...
      <div className="h-[300px] flex md:justify-start justify-center items-center md:px-[100px] w-full ">
        <div className="flex justify-start flex-col">
          <h1 className="ms-0 mt-3 md:mt-2 text-[17px] md:text-2xl text-start text-white opacity-40">
            {data[0].intro}
          </h1>
          <h1 className="text-3xl md:text-6xl  m-1 font-bold text-white opacity-40">
            {data[0].name}
          </h1>
          <h1 className="text-[20px] md:text-2xl m-1 shadow-lg text-white opacity-40">
            {data[0].role}
          </h1>
          <Cv />
        </div>
